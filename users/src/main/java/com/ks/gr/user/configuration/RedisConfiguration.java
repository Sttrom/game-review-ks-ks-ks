package com.ks.gr.user.configuration;
...
public class RedisConfiguration {
    ...
    public class RefreshTokenKeyspaceConfiguration extends KeyspaceConfiguration {
        ...
        protected Iterable<KeyspaceSettings> initialConfiguration() {
            KeyspaceSettings settings = new KeyspaceSettings(RefreshTokenEntity.class, REFRESH_TOKEN_KEYSPACE);

            settings.setTimeToLive(refreshTokenDuration.getSeconds());
